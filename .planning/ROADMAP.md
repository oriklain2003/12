...
| 4 | Frontend Canvas, Nodes, Sidebar & Dark Theme | Full visual editor with drag, configure, connect | FRONT-02 to FRONT-12 | 5 | 1/3 | In Progress|  | Full loop — dashboard, save/load, run with live status | WFLOW-01 to WFLOW-08 | 4 |
