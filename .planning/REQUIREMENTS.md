...
- [ ] **WFLOW-01**: React Router with routes: / (dashboard), /workflow/:id (editor), /workflow/new (new workflow)
...
- [ ] **WFLOW-03**: Save serializes current flow state (nodes, edges, params) to backend via PUT; Load deserializes and restores canvas
